...
const AUTH_MAP: Record<string, OperationAuthRequirement> = {
  ...
  bookingsForPatient:      { authenticated: true, minRole: Role.CUSTOMER },
  myBookings:               { authenticated: true, minRole: Role.CUSTOMER },
  currentPatientBooking:   { authenticated: true, minRole: Role.CUSTOMER },
  upcomingPatientBookings: { authenticated: true, minRole: Role.CUSTOMER },
  pastPatientBookings:     { authenticated: true, minRole: Role.CUSTOMER },
  patientBookings:         { authenticated: true, minRole: Role.CUSTOMER },
  ...
  paymentsByPatient:{ authenticated: true, minRole: Role.CUSTOMER },
  ...
  submitPatientReview:         { authenticated: true, minRole: Role.CUSTOMER },
  submitOwnerReplyToPatientReview: { authenticated: true, minRole: Role.OWNER },
