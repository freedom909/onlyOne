export const TOKENS_TENANT = {
   ...
   useCases: {
    ...
    inviteMember: Symbol.for("inviteMemberUseCase"),
    updateMemberRole: Symbol.for("updateMemberRoleUseCase"),
    removeMember: Symbol.for("removeMemberUseCase"),
    myMemberships: Symbol.for("myMembershipsUseCase"),
    getCurrentTenant: Symbol.for("getCurrentTenantUseCase"),
    getTenantMemberships: Symbol.for("getTenantMembershipsUseCase"),
  },
} as const;
