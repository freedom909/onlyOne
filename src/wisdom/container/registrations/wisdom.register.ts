...
import { PatientExtractor } from "@/wisdom/semantic/extractors/patient.extractor";
...
export function registerWisdom() {
  ...
  container.register(WISDOM_TOKENS.extractors.patientExtractor, { useClass: PatientExtractor });
