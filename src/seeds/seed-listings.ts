...
const LISTINGS = [
  ...
  {
    id: "lst-osaka-003",
    title: "Studio in Osaka Center",
    description: "Modern studio apartment in the heart of Osaka Center. Close to shopping centers, restaurants, and public transport. Great for single travelers.",
    ownerId: "owner-004",
    locationId: "loc-osaka-center",
    address: "Osaka Center, Chuo-ku, Osaka, Japan",
    numOfBeds: 1,
    numOfPatients: 2,
    numOfBathrooms: 1,
    numOfRooms: 1,
  ...
  },
  {
    ...
    ownerId: "owner-004",
    locationId: "loc-kyoto",
    address: "〒600-8019 京都府京都市下京区船頭町204",
    numOfBeds: 2,
    numOfPatients: 5,
    numOfBathrooms: 1,
    numOfRooms: 2,
    price: 10000,
    picture: ["https://images.unsplash.com/photo-1505693416388-ac5ce068fe85"],
    isFeatured: true,
  },
];
