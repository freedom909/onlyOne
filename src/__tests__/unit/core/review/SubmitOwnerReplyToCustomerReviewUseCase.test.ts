...
describe("SubmitOwnerReplyToPatientReviewUseCase", () => {
  let useCase: SubmitOwnerReplyToPatientReviewUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new SubmitOwnerReplyToPatientReviewUseCase(
      mockRepo as any,
  ...
  it("should pass through full input to moderation policy", async () => {
    const input = {
      ...
      ownerId: "owner-1",
      patientReviewID: "review-1",
      hostReview: { content: "Great patient!", rating: 5, round: 2 },
