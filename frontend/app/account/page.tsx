...
import { BECOME_DOCTOR } from "../graphql/user/mutation/becomeHost";
...
function AccountDashboardContent() {
  ...
  return (
    <div>
      ...
      {me && me.role && me.role !== "DOCTOR" && me.role !== "ADMIN" && me.role !== "SUPER_ADMIN" && (
...
function BecomeHostBanner(_props: { userId: string }) {
  const [becomeHost, { loading, error }] = useMutation<any>(BECOME_DOCTOR, {
