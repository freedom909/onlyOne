...
export default function HostCreateListingPage() {
  return (
    <RoleGuard allowedRoles={["DOCTOR", "OWNER", "ADMIN", "SUPER_ADMIN"]}>
...
function CreateListingContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const input = {
        ...
        numOfPatients: parseInt(form.numOfPatients) || 2,
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <p className="text-sm text-gray-500 mb-6">List your property for guests to book</p>
