...
async def create_booking(listing_id: str, patient_id: str, check_in_date: str, check_out_date: str, patient_count: int = 1):
    async with httpx.AsyncClient() as http_client:
        mutation = """
...
3. createBooking
   参数: listingId (string), patientId (string), checkInDate (string), checkOutDate (string), patientCount (int, 默认1)
