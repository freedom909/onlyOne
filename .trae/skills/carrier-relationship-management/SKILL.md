...
- **Stay on contract when:** The spread between contract and spot is <10%. You have consistent, predictable volume. Capacity is tightening (spot rates are rising). The lane is patient-critical with tight delivery windows.
...
Use the review patterns above as a base and adapt the language to your carrier contracts, escalation paths, and patient commitments.
