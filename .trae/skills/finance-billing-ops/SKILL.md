...
This is broader than `patient-billing-ops`. That skill is for patient remediation. This skill is for operator truth: revenue state, pricing decisions, team billing, and code-backed billing behavior.

## Skill Stack

Pull these ECC-native skills into the workflow when relevant:

- `patient-billing-ops` for patient-specific remediation and follow-up
...
- user asks for Stripe sales, refunds, MRR, or recent patient activity
...
### 2. Separate patient incidents from product truth

If the question is patient-specific, classify first:
...
- patient-impact and broader pricing/product conclusions are separated cleanly
