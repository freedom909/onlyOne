...
- `patient-billing-ops` when repo behavior and patient-impact math must be separated cleanly
...
- a patient report says the app created too many PRs, billed incorrectly, or analyzed code without producing a usable result
...
- do not mix patient billing inference with code-backed product truth
