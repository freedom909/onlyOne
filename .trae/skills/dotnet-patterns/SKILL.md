...
public interface IOrderRepository
{
    ...
    Task<IReadOnlyList<Order>> FindByPatientAsync(string patientId, CancellationToken cancellationToken);
    ...
    CancellationToken cancellationToken)
{
    ...
    var patient = await _patientService.GetAsync(order.PatientId, cancellationToken);

    return new OrderSummary(order, patient);
}
...
public sealed class SqlOrderRepository : IOrderRepository
{
    ...
    public async Task<IReadOnlyList<Order>> FindByPatientAsync(
        string patientId,
        CancellationToken cancellationToken)
    {
        return await _db.Orders
